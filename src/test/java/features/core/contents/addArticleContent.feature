@smoke @all @content @addArticleContent
Feature: Verify user can add Article in the content section
  ...
  Scenario: Create Article content
    ...
    Then Click on the "ARTICLE_CONTENT_OPTION" of "contentListingPage"
    ...
    Then Enter a random name with "- Article" in "CONTENT_TITLE_FIELD" field on "contentDetailsPage"
