@smoke @all @content @addImageContent
Feature: Verify user can upload image in the content section
  ...
  Scenario: Create image content
    ...
    Then Click on the "IMAGE_CONTENT_OPTION" of "contentListingPage"
    Then Click on the "SELECT_UPLOAD_BUTTON" of "contentListingPage"
    Then Import a file "content_IMG.jpg" from "UPLOAD_FILE" of page "contentDetailsPage"
    ...
    Then Enter a random name with ".jpg" in "CONTENT_TITLE_FIELD" field on "contentDetailsPage"
