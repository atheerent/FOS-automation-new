...
Feature: Verify XLS import user scenario
  ...
  Scenario: Import users from XLS file located in s3 bucket
    ...
    Then Import a file "importUsers.xlsx" from "UPLOAD_FILE" of page "userListingPage"
