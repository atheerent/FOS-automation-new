@smoke @all @conversation @deleteConversation
Feature: Verify user can delete conversation from Atheer web App
  ...
  Scenario: Delete the group conversation
    ...
    Then Click on the "DELETE_THIS_CONVERSATION_BUTTON" of "conversationPage"
    Then Click on the "DELETE_BUTTON" of "conversationPage"
