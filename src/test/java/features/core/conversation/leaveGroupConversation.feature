@smoke @all @conversation @leaveGroupConversation
Feature: Verify user can leave the group conversation from Atheer web App
  ...
  Scenario: Leave the group conversation
    ...
    Then Click on the "LEAVE_THIS_CONVERSATION_BUTTON" of "conversationPage"
    Then Click on the "LEAVE_BUTTON" of "conversationPage"
